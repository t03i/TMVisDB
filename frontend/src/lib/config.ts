...
import { PUBLIC_API_URL, PUBLIC_PROJECT_NAME, PUBLIC_GITHUB_REPO,PUBLIC_MIN_PROTEIN_LENGTH, PUBLIC_MAX_PROTEIN_LENGTH, PUBLIC_MAINTENANCE_MESSAGE, PUBLIC_MAINTENANCE_MODE } from '$env/static/public';
...
const config: Config = {
    ...
    GITHUB_URL: `https://github.com/${PUBLIC_GITHUB_REPO}` || 'https://github.com/t03i/tmvisdb',
